...
{
    public class DateFantasyDbInitializer : DropCreateDatabaseIfModelChanges<DateFantasyContext>
    {
        public DateFantasyDbInitializer()
        {

        }

        protected override void Seed(DateFantasyContext context)
        {
            //base.Seed(context);
        ...
        private void AddData(DateFantasyContext context)
        {
