namespace DateFantasy.Migrations
{
    using Entities;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DateFantasy.Data.DateFantasyContext>
    {
        ...
        protected override void Seed(DateFantasy.Data.DateFantasyContext context)
        {
            ...
            var members = new List<Member>()
            {
                ...
                new Member()
                {
                    ...
                    Profile = new Profile()
                    {
                        Introduction = @"Easy-going On The Road but then it wouldn't be private easy-going. Jazz cafes I'm not good at filling out these things  fixing my scooter jazz cafes coffee, bacon I'm not good at filling out these things mountain biking only looking for something  casual Myers-Briggs. Discussing politics the simple things in life nothing too complicated Myers-Briggs I'm just a regular guy everything but country music. Working on my body and my mind knowing the difference between their/there/they're introvert playing my guitar. I'm a big fan of glass half-full my dogs just looking to have some fun fascinates me, my friends tell me they don't get why I'm single going back to school working on my body and my mind Kurosawa my eyes. I   know I listed more than 6 things  medical school Sunday funday medical school grilling it depends on the  night.",
                ...
                new Member()
                {
                    ...
                    Profile = new Profile()
                    {
                        Introduction = @"Introvert knowing the difference between their/there/they're as friends fixing my scooter. Sleeping late my goofy smile my eyes loyal whatever topic is on NPR, grilling someone who shares my sense of humor bored at home joking around everything but country music. Share a new experience as friends medical school fascinates me my goofy smile art school. Sunday funday easy-going fixing my scooter chilling at a bar with friends. Playing my guitar happy hour joking around short-term dating On The Road, I don't take myself too seriously working at a coffee shop training for the marathon knowing the difference between their/there/they're skiing. My cats Indian food Indian food Infinite Jest foreign films Game of Thrones.",
